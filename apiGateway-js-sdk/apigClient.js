...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ik80a4tzv2.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.photosObjectPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customlabels', 'Content-Type', 'object'], ['body']);
